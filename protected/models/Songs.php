...
class Songs extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, songListId', 'required'),
			array('songListId', 'numerical', 'integerOnly'=>true),
			array('name, writer, singer, type', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, writer, singer, type, songListId', 'safe', 'on'=>'search'),
		);
	}
