...
class Feedbacks extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customerId, receptorId', 'required'),
			array('customerId, receptorId', 'numerical', 'integerOnly'=>true),
			array('content', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customerId, receptorId, content', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'receptors' => array(self::HAS_MANY, 'Receptors', 'feedbackId'),
		);
	}
